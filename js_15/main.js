...
function myPow(a, b, func) {
  let res = function res(a, b) {
  ...
  return func(a,b,res(a,b))
};

console.log(myPow(2, 3, myPrint)); // 3^4=81
...
car3.used = 'used';
console.log(car3.info()); // Infinite FX50 AWD, 5000cc, year 2019, new
...
console.log(myDouble(7)); // = myMul(2, 3) = 6
