...
function mainFunc(a, b, func) {
    if (( typeof a === "number") && (typeof b === "number") && (typeof func === "function")){
    return func(a,b);
    } else {
        return false;
    }
...
//console.log (cbRandom(a, b)) – вычисляет и возвращает произвольное целое число в диапазоне между a и b включительно.
...
// cbAdd(a, b) – вычисляет и возвращает сумму двух чисел a и b.
 ...
 //console.logmainFunc() должна возвращать результат работы переданной ей возвратной функции, например:
